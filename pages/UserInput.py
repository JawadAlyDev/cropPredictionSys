...
# # SVM MODEL
SVM_Model = joblib.load("Model_Training_SVM.pkl")
y_pred = SVM_Model.predict(X_test_selected)
svm_accuracy = accuracy_score(y_test, y_pred)
print(f'Accuracy: {svm_accuracy * 100:.2f}%')

# # LOGISTIC REGRESSION
LR_Model = joblib.load("Model_Training_Logistic.pkl")
...
# # Decision Tree
DT_Model = joblib.load("Model_Training_Decision.pkl")
y_pred_dt = DT_Model.predict(X_test_selected)
dt_accuracy = accuracy_score(y_test, y_pred_dt)
print(f'Accuracy: {dt_accuracy * 100:.2f}%')

# # K-Nearest Neighbour
KNN_Model = joblib.load("Model_Training_KNN.pkl")
y_pred_knn = KNN_Model.predict(X_test_selected)
knn_accuracy = accuracy_score(y_test, y_pred_knn)
print(f'KNN Accuracy: {knn_accuracy * 100:.2f}%')

# # GussianNB
Gaussian_Model = joblib.load("Model_Training_Gussian.pkl")
y_pred_nb = Gaussian_Model.predict(X_test_selected)
nb_accuracy = accuracy_score(y_test, y_pred_nb)
print(f' GussianNB Accuracy: {nb_accuracy * 100:.2f}%')

# # Random Forest
RF_Model = joblib.load("Model_Training_Random.pkl")
X_test_selected = selector.transform(X_test_scaled)
